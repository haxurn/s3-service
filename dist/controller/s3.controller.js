import { uploadToS3, getFileMetadata, deleteFile as deleteFileService, logUploadToDB } from "../service/s3.service.js";
import { generateFileKey } from "../utils/uuid.js";
...
export const getUploadedFile = async (c) => {
    try {
